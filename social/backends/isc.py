...
from social.exceptions import AuthMissingParameter, AuthFailed, AuthCanceled
...
class BaseISCAuth(object):
    ...
    def get_isc_public_key(self):
        certificate = load_pem_x509_certificate(
            self.setting('SOCIAL_AUTH_ISC_SERVER_CERT'),
            default_backend()
        )
...
class BaseISCOAuth2API(BaseISCAuth):
    ...
    def user_data(self, access_token, *args, **kwargs):
        ...
        url = 'https://login.intersystems.com/uatlogin/oauth2/userinfo'
...
class ISCOAuth2(BaseISCOAuth2API, BaseOAuth2):
    ...
    AUTHORIZATION_URL = 'https://login.intersystems.com/uatlogin/oauth2/authorize'
    ACCESS_TOKEN_URL = 'https://login.intersystems.com/uatlogin/oauth2/token'
    ACCESS_TOKEN_METHOD = 'POST'
    REVOKE_TOKEN_URL = 'https://login.intersystems.com/uatlogin/oauth2/revocation'
