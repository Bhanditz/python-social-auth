...
class BaseISCOAuth2API(BaseISCAuth):
    ...
    def user_data(self, access_token, *args, **kwargs):
        ...
        url = 'https://login-base.intersystems.com/oauth2/userinfo'
...
class ISCOAuth2(BaseISCOAuth2API, BaseOAuth2):
    ...
    AUTHORIZATION_URL = 'https://login-base.intersystems.com/oauth2/authorize'
    ACCESS_TOKEN_URL = 'https://login-base.intersystems.com/oauth2/token'
    ACCESS_TOKEN_METHOD = 'POST'
    REVOKE_TOKEN_URL = 'https://login-base.intersystems.com/oauth2/revocation'
